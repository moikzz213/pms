...
const columns = [
    ...
    { id: "title", label: "Location", minWidth: 30 }, 
];
...
const Locations = () => {
    ...
    const handleSearch = (e) => {
        if(e.target.value.length > 3){
           ...
           axiosFunction("/v/locations/search/"+ e.target.value);

        }else if(e.target.value.length == 0){
            axiosFunction("/v/locations/search/-");
        }
    };
    ...
    const deleteData = (e) => { 
        axios.post("/v/locations/delete", e)
        .then((response) => {
            setTimeout(() => {
                fetchLocations();
            },200);
    ...
    return (
        <>
            ...
            >
                <Link to="/d/settings/locations/create">
